...
eos_info="$(curl --fail "${EPIC_GAMES_URL}/api/cosmos/sdk")"
...
download_url="${EPIC_GAMES_URL}/api/cosmos/sdk/download?archive_id=${eos_sdk_archive_id}&archive_type=${EPIC_GAMES_SDK_TYPE}"
